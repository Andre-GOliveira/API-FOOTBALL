...
#%%
def process_fixtures(df_fixture_load, config):
    ...
    return fixture_lineups, pd.DataFrame(final_status_list)
...
display(df_fixture_load)
#%%
fixture_lineups, df_final_status = process_fixtures(df_fixture_load, config)
